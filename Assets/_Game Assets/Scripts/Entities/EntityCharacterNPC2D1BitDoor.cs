...
public class EntityCharacterNPC2D1BitDoor : EntityCharacterNPC2D1Bit
{
    ...
    private void _UpdateLineRenderer()
    {
        ...
        switch (m_doorType)
        {
            ...
            case DoorType.NeedPassword:
                string key = ProfileManager.PLAYERPREFS_HAVEPASSWORD + "-" + UnityEngine.SceneManagement.SceneManager.GetActiveScene().name + "-" + m_doorTypePassword_eventId;
            ...
            case DoorType.SwitchPassword:
                string key2 = ProfileManager.PLAYERPREFS_HAVEPASSWORD + "-" + UnityEngine.SceneManagement.SceneManager.GetActiveScene().name + "-" + m_doorTypePassword_eventId;
    ...
    private void _EnterPasswordRecursive(PasswordChoice[] passwordChoices, Action trueAction, Action wrongAction)
    {
        ...
        string dialogueStr = cPC.hintDialogue.dialogueStr + ((cPC.revealAnswer) ? "\n(" + LocalizationManager.Translate(LocalizationManager.THE_ANSWER_IS) + LocalizationManager.Translate(cPC.choiceStrings[cPC.trueAnswer]) + ".)" : "");
